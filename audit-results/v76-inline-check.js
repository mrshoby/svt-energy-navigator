    ...
    function setTab(tab){
      ...
      showMessage(electric ? 'warn' : 'ok', electric ? 'Completează minim tariful și alege modul de încărcare. Pentru varianta recomandată, încarcă fișierul orar de consum.' : 'Datele termice sunt salvate pentru analiza integrată, dar întrebarea 1 se calculează pe consum electric.');
      validateForm();
    }
