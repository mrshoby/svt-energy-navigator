    ...
    function setLoadMethod(method){
      ...
      fileModeBox.style.display = method === 'file' ? 'block' : 'none';
    ...
    function initDistributorHelpModal(){
      ...
      const openBtn = document.getElementById('openDistributorHelp');
      ...
      const activate = (id) => {
        tabs.forEach(t => t.classList.toggle('active', t.dataset.distTab === id));
        panels.forEach(p => p.classList.toggle('active', p.dataset.distPanel === id));
      };
      ...
      tabs.forEach(t => t.addEventListener('click', () => activate(t.dataset.distTab)));
    }
    ...
    function initDistributorHelpModalForcedV651(){
      const openBtn = document.getElementById('openDistributorHelpForced');
      const modal = document.getElementById('distributorHelpModal');
    ...
    document.addEventListener('DOMContentLoaded', initDistributorHelpModalForcedV651);
